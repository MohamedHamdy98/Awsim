...
public class WomanActivity extends AppCompatActivity {
    ...
    private void firebase_edit_number_phone() {
        ...
        myRef.child("number phone woman 1").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void initialization() {
        tvPhone1 = findViewById(R.id.textView_woman_phone1);
        btnphone1 = findViewById(R.id.button_phone_woman_number1);
    }
