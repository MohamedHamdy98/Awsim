...
public class EyeActivity extends AppCompatActivity {
    ...
    private void firebase_edit_number_phone() {
        ...
        myRef.child("number phone eye 1").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void initialization() {
        tvPhone1 = findViewById(R.id.textView_eye_phone1);
        btnphone1 = findViewById(R.id.button_eye_phone_number1);
    }
}
