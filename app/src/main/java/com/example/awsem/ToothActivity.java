...
public class ToothActivity extends AppCompatActivity {
    ...
    private void firebase_edit_number_phone() {
        ...
        myRef.child("number phone tooth 1").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        myRef.child("number phone tooth 2").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void initialization() {
        tvPhone1 = findViewById(R.id.textView_tooth_phone1);
        tvPhone2 = findViewById(R.id.textView_tooth_phone2);
        btnphone1 = findViewById(R.id.button_tooth_phone_number1);
        btnphone2 = findViewById(R.id.button_tooth_phone_number2);
    }
}
