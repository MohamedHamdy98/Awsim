...
public class GeneralSerguryActivity extends AppCompatActivity {
    Button btnphone1;
    TextView tvPhone1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_sergury);
        initialization();
    ...
    private void firebase_edit_number_phone() {
        ...
        myRef.child("number phone generalsergury 1").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void initialization() {
        tvPhone1 = findViewById(R.id.textView_generalsergury_phone1);
        btnphone1 = findViewById(R.id.button_generalsergury_phone_number1);
    }
