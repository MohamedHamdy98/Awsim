...
public class NoseActivity extends AppCompatActivity {
    ...
    private void firebase_edit_number_phone() {
        ...
        myRef.child("number phone nose 1").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        myRef.child("number phone nose 2").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void initialization() {
        tvPhone1 = findViewById(R.id.textView_nose_phone1);
        tvPhone2 = findViewById(R.id.textView_nose_phone2);
        btnphone1 = findViewById(R.id.button_nose_phone_number1);
        btnphone2 = findViewById(R.id.button_nose_phone_number2);
    }
}
