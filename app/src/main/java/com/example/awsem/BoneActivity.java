...
public class BoneActivity extends AppCompatActivity {
    ...
    private void firebase_edit_number_phone() {
        ...
        myRef.child("number phone bone 1").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void initialization() {
        tvPhone1 = findViewById(R.id.textView_bone_phone1);
        btnphone1 = findViewById(R.id.button_bone_phone_number1);
    }
